...
| # | Problem | Type |
|---|---------|------|
| 1 | Print Numbers | Auto-graded |
| 2 | CSV Column Mean | Auto-graded |
| 3 | Filter and Aggregate | Auto-graded |
| 4 | String Parsing | Auto-graded |
| 5 | Merge and Summarize | Auto-graded |
| 6 | Moving Average | Auto-graded |
| 7 | Debug Off-by-One | Auto-graded |
| 8 | Optimize Search | Auto-graded |
| 9 | Word Frequency Count | Auto-graded |
| 10 | Date Range Filtering | Auto-graded |
| 11 | Matrix Operations | Auto-graded |
| 12 | Data Validation & Cleaning | Auto-graded |
| 13 | Boxplot — Temperature by Station | Figure (reviewed) |
